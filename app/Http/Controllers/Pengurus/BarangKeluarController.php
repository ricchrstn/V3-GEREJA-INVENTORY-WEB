    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            NotificationHelper::create('admin',
                'Barang Keluar Baru',
                'Barang keluar baru telah dicatat: ' . $barang->nama . ' (' . $validated['jumlah'] . ' ' . $barang->satuan . ') oleh ' . auth()->user()->name,
                'barang_keluar',
                'fa-arrow-up',
                'danger'
            );
    ...
    public function update(Request $request, BarangKeluar $barangKeluar)
    {
        ...
        try {
            ...
            NotificationHelper::create('admin',
                ...
                'Data barang keluar untuk ' . $barang->nama . ' telah diperbarui oleh ' . auth()->user()->name,
                'barang_keluar',
                'fa-edit',
                'warning'
            );
